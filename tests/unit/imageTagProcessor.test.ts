...
import { DEFAULT_WEBP_SETTING } from "../../src/uploader/webpConverter";
...
const makeSettings = (overrides: any = {}) =>
  ({
    ...
    // loadSettings always fills this in from the defaults; uploadLocalImage
    // reads it unguarded when deciding whether to archive the original.
